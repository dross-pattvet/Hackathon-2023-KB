...
if __name__ == '__main__':
    ...
    while True:
        ...
        kb = get_kb(True, main_scratchpad)

        print('kb: ', kb)
        default_system = open_file('system_default.txt').replace('<<KB>>', kb)
        ...
        all_messages.append('SEYMOUR: %s' % response)
        print('\n\nSEYMOUR: %s' % response)
